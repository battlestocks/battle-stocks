...
from battle_stocks.utils.sp_500 import SP_500
...
# data = get_historical_stock_price(SYMBOL['APPLE'])
# data = data[1:]
# for i in data:
#   if len(i) < 5:
#     continue
...
# apple = Transaction(STOCKS.APPLE, 300)
# apple.get_price_history()
# apple.plot()
